[1:10 PM, 1/15/2025] 𝙒𝙤𝙡𝙫𝙚𝙨 𝑨𝑫𝑴𝑰𝑵 •: <!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
body {
    ...
    min-height: 100vh;
    position: relative;
    background-image: url(https://i.postimg.cc/9WjFkQm4/bg.jpg);
...
.container {
    background: linear-gradient(145deg, rgb(10, 10, 10), rgba(8, 8, 8, 0.938));
    border-radius: 15px;
...
.telegram-button {
    ...
    height: 60px;
    border-radius: 50%;
    background: url('https://i.postimg.cc/bw1YvKTN/dark-logo.jpg') no-repeat center/cover;
...
<body>
    ...
    <div class="container">
        <h1 style="color,black">𝙒𝙤𝙡𝙫𝙚𝙨 𝗦𝗶𝗺 𝗗𝗮𝘁𝗮</h1>
        <form method="post">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($mobile)) {
                $url = "https://tmphpscripts.xyz/Tajammal.php?num=" . $mobile;
                $ch = curl_init();
    ...
    <div class="developer">𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 ↬𝙔𝘼𝙈𝙄</div>
